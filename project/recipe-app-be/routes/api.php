...
Route::group([
    ...
    Route::get('/{recipeList}/recipe',[ RecipeController::class, 'index']); 
    Route::post('/{recipeList}/recipe',[ RecipeController::class, 'addRecipe']); 
    Route::delete('/{recipeList}/recipe/{recipe}',[ RecipeController::class, 'delete']); 
});
